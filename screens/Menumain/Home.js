    ...
    return (
        ...
        <SafeAreaView style={styles.backgroundImage}>
            <View style={styles.headerview}>
                ...
                <Text
                    style={styles.TextName}>{(username !== null && username !== '') ? username : (userData && userData.username) || 'ชื่อ-สกุล'}</Text>
                ...
                <View style={{flexDirection: "row", justifyContent: "space-around"}}>
                    ...
                    <Text
                        style={styles.Textheaddata2}>{(insulinType !== null && insulinType !== '') ? insulinType : (userData && userData.insulinType) || 'ชนิดยาอินซูลิน'}</Text>
                </View>

                <View style={{flexDirection: "row", justifyContent: "space-around"}}>
                    <Text
                        style={styles.Textheaddata2}>{(minsugar !== null && minsugar !== '') ? minsugar : (userData && userData.minsugar) || 'mg/dL'}</Text>
                    <Text style={styles.Textheaddata2}>-</Text>
                    <Text
                        style={styles.Textheaddata2}>{(maxsugar !== null && maxsugar !== '') ? maxsugar : (userData && userData.maxsugar) || 'mg/dL'}</Text>
                    <Text style={styles.Textheaddata}> </Text>
                    <Text style={styles.Textheaddata2}>จำนวน</Text>
                    <Text
                        style={styles.Textheaddata2}>{(insulinUnits !== null && insulinUnits !== '') ? insulinUnits : (userData && userData.insulinUnits) || 'จำนวน ... ยูนิต'}</Text>
